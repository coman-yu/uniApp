    ...
    <view class="bottom_btn"
      ><view class="first_btn"
        ><u-button
          ...
          @click="pageBack"
        >
          <u-icon name="arrow-left" color="#051C2C" size="30"></u-icon>
          <text
            class="fw_500"
      ...
      ><view class="first_btn"
        ><u-button
          ...
          color="#051C2C"
        >
          <u-icon name="bookmark" color="#ffffff" size="35"></u-icon>
      ...
      ><view class="first_btn"
        ><u-button
          ...
          color="#051C2C"
        >
          <u-icon name="share-square" color="#051C2C" size="35"></u-icon>
